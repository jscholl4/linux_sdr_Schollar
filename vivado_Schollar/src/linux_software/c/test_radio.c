...
//  
//  Description:
//      Script to generate tone through full_radio IP peripheral.
//  
//      This script was largely provided by the instructor.
//      The only changes to the script occur within the
//      print_benchmark() and main() functions. Specifically,
//      lines 79-81 and 93.
//  
//----------------------------------------------------------------
...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float bytes_transferred = 4*2048; 
    float time_spent = (stop_time-start_time) / 125000000.0;       // total number of clock cycles divided by clock speed
    float throughput = (bytes_transferred/time_spent) / 1000000.0; // bytes/second divided by 1e6
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Jeremiah Schollar - Custom Peripheral Demonstration\n\r");
